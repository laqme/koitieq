...
This part of Koıtıeq serves as documentation for Kuna. It will be a fair bit more complex than the rest of Koıtıeq. You'll want to have read and mostly understood all of the colored boxes in Koıtıeq itself before tackling this guide.
