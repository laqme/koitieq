...
> **Mıqte:** _Nho. He baı nhána báq pıca noqgı._{:.t.sec data-audio="9 both 4"}<br>
> **Lucas:** _Kéo naı baı nhána sía raı._{:.t data-audio="9 both 5"}<br>
> **Mıqte:** _Ubaı._{:.t.sec data-audio="9 both 6"}<br>
> **Lucas:** _Tao úmo hí raı móq?_{:.t data-audio="9 both 7"}<br>
> **Mıqte:** _Eju… enı! He cho jí máo ní sushırıaq._{:.t.sec data-audio="9 both 8"}<br>
