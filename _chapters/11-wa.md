...
| Word | Meaning |
| --- | --- |
| _ruaq_{:.t} | ▯ states that ▯ |
| _zoaı_{:.t} | ▯ doubts that ▯ |
| _mıu_{:.t} | ▯ opines that ▯ |
| _chı_{:.t} | ▯ believes that ▯ |
| _dua_{:.t} | ▯ knows that ▯ |
| _cuo_{:.t} | ▯ assumes that ▯ |
| _aojaı_{:.t} | ▯ wants that ▯ |
| _zaı_{:.t} | ▯ hopes that ▯ |
| _juna_{:.t} | it's true that ▯ |
| _sahu_{:.t} | it's false that ▯ |
| _le_{:.t} | it's likely that ▯ |
| _laheq_{:.t} | ▯ entails/implies ▯ |
| _dana_{:.t} | ▯ defeats ▯ |
...
In other words, _ꝡá_{:.t} is short for _ké raı ꝡä_{:.t} and _ꝡé_{:.t} is short for _ké raı ꝡë_{:.t}.

> _Cho jí, **ꝡé** fıeq súq hóa._{:.t}<br>
> I like **what** you invent.
>
> _Cho jí **ké lua, ꝡë** fıeq súq hóa._{:.t}<br>
